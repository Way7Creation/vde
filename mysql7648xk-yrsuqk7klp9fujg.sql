...
--
-- Хост: localhost
-- Время создания: Май 26 2025 г., 17:15
...
--
-- Дамп данных таблицы `city_warehouse_mapping`
--

INSERT INTO `city_warehouse_mapping` (`city_id`, `warehouse_id`) VALUES
(3, 1);
...
--
-- Дамп данных таблицы `delivery_schedules`
--

INSERT INTO `delivery_schedules` (`schedule_id`, `warehouse_id`, `city_id`, `delivery_days`, `delivery_type`, `cutoff_time`, `is_express`, `min_order_amount`, `specific_dates`, `delivery_mode`) VALUES
(3, 1, 1, '[3]', 1, '16:00:00', 0, '5000.00', NULL, 'weekly'),
(4, 1, 3, '[1, 2, 4, 5]', 1, '16:00:00', 0, '10000.00', NULL, 'weekly');
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password_hash`, `role_id`, `is_active`, `created_at`, `updated_at`, `is_guest`, `first_name`, `last_name`, `phone`, `is_legal_entity`, `inn`, `company_name`, `city_id`) VALUES
(1, 'waysen_admin', 'vde76ru@yandex.ru', '$2y$10$BQAhwxEICT6v.xKk9mlbweO820FjbumfgPQLK/zQjOTf9PXXAIeZO', 1, 1, '2025-05-02 11:52:58', '2025-05-05 21:13:43', 0, NULL, NULL, NULL, 0, NULL, NULL, 3);
...
INSERT INTO `warehouses` (`warehouse_id`, `name`, `city_id`, `address`, `contact_phone`, `working_hours`, `is_active`) VALUES
(1, 'Русский свет — Тверь', 1, NULL, NULL, NULL, 1);
